...
namespace Pleiades.Tool.Services
{
    /// <summary>
    ...
    public static class ColorConsole
    {
        ...
        public static void WriteLine(string text, ConsoleColor? color = null)
        {
            ...
            else
            {
                ...
                ConsoleColor newColor = color.GetValueOrDefault();
        ...
        /// <param name="color">A console color. Must match ConsoleColors
        /// collection names (case insensitive).</param>
        ...
        public static void WriteEmbeddedColorLine(string text,
            ConsoleColor? baseTextColor = null)
        {
